...
# - 9장: 동적 크롤링을 하는 방법과 정규 표현식을 이용하는 방법에 대해 배워봅니다.
...
# ## 이 책의 지원 페이지
# 
# 이 책은 파이썬의 jupyterbook 패키지로 작성되어 웹페이지 및 GitHub 저장소에 공유되어 있습니다. 따라서 책에 포함되어 있는 각종 코드를 웹페이지에 방문하여 얻을 수 있으며, 하단의 댓글 부분을 통해 질문사항을 남길수도 있습니다. 이 외에도 퀀트 투자 및 파이썬, R을 이용한 투자 활용법 등의 내용은 저자의 블로그에 많은글들이 있으니 참조하기 바랍니다.
# 
